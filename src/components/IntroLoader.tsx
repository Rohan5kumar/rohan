...
export const IntroLoader: React.FC<IntroLoaderProps> = ({ onComplete }) => {
  ...
  useEffect(() => {
    ...
    if (index < words.length - 1) {
      ...
      const timeout = setTimeout(() => {
        ...
        setIsVisible(false);
        // The exit animation takes 800ms
  ...
  if (!isVisible && sessionStorage.getItem('hasSeenIntro')) return null;
        ...
        >
          <motion.div
            ...
            className={`
              ...
              ${isFinalWord ? 'font-teko text-neon-cyan font-bold' : 'font-sans text-white font-medium animate-glitch'}
            `}
            style={{
